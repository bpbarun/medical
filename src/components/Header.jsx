        ...
        <>
            <header className="main-header">
                <a href="/" className="logo">
                    <span className="logo-lg"><b>Easy Medical</b></span>
                </a>
                <nav className="navbar navbar-static-top">
                    <a href="#" className="sidebar-toggle" data-toggle="push-menu" role="button">
                        <span className="sr-only">Toggle navigation</span>
                    </a>
                    {localStorage.getItem("user_role") === 'admin' &&<button className="btn request-for-approval-btn" data-toggle="modal" data-target="#requestForApproval" aria-hidden="true">Leave Approval ({noOfRequest})</button> }
